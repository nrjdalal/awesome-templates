...
This template is bootstrapped with [next.js-pro.sh](https://github.com/nrjdalal/awesome-templates/blob/main/.github/.scripts/next.js-pro.sh) and is part of the [awesome-templates](https://github.com/nrjdalal/awesome-templates) repository, to explore a curated collection of up-to-date templates for various projects and frameworks, refreshed every hour.
