...
This template is bootstrapped with script [docs-tanstack.sh](https://github.com/nrjdalal/awesome-templates/blob/main/.github/.scripts/docs-tanstack.sh) and is part of the [awesome-templates](https://github.com/nrjdalal/awesome-templates) repository, to explore a curated collection of up-to-date templates for various projects and frameworks, refreshed every 8 hours.

## Clone this template

```bash
npx gitpick@latest nrjdalal/awesome-templates/tree/main/docs-apps/docs-tanstack
```
